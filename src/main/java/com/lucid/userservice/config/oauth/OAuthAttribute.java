...
import com.lucid.userservice.config.oauth.response.GoogleOAuth2UserInfo;
import com.lucid.userservice.config.oauth.response.KakaoOAuth2UserInfo;
import com.lucid.userservice.config.oauth.response.NaverOAuth2UserInfo;
import com.lucid.userservice.config.oauth.response.OAuth2UserInfo;
...
public class OAuthAttribute {
    ...
    public Member toEntity(SocialType socialType, OAuth2UserInfo oauth2UserInfo) {
        return new Member(oauth2UserInfo.getEmail(), Role.ROLE_GUEST, socialType, oauth2UserInfo.getId());
    }
}
